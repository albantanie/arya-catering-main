            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    Swal.fire({
                        ...
                        text: 'Tidak ada item di keranjang Anda. Silakan tambahkan item terlebih dahulu.',
                ...
                <div class="col-12 col-md-4">
                    <div class="border rounded p-4">
                        ...
                        <form id="checkout-form" action="{{ route('user.transaction.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                            ...
                            <button type="submit" class="btn btn-secondary w-100 mt-3">Lanjut ke pembayaran</button>
                        </form>
                    </div>
                </div>
            </div>
