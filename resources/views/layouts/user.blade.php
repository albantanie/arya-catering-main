...
@section('body')
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('user.index') }}">Dapoer Lina</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                @if (auth()->user())
                    <ul class="navbar-nav ms-auto me-3 mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link fs-4" aria-current="page" href="{{ route('user.cart.index') }}"><i
                                    class="bi bi-cart"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4" href="{{ route('user.transaction.index') }}"><i
